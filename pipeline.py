...
LUA_SHA1 = get_hash(os.path.join(CWD, 'jux.lua'))
...
project = Project(
    ...
    project_html="""
        ...
        <h2>jux.com <span class="links"><a href="http://jux.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/jux/">Leaderboard</a></span></h2>
        <p>Archiving all jux pages.</p>
    """,
    utc_deadline=datetime.datetime(2014, 11, 30, 23, 59, 0)
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="jux"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
